...
namespace sampleplayer
{
...

    {
        ...
        public:
            ...
            virtual void OnStartButtonPressed   (int period, int videoAdaptationSet, int videoRepresentation, int audioAdaptationSet, int audioRepresentation, int adaptation);
