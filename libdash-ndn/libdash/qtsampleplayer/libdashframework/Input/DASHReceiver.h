...
#include "../Adaptation/RateBaseAdaptation.h"
#include "../Adaptation/QoeFairAdaptation.h"
#include "../Adaptation/RateBufferBaseAdaptation.h"
#include "../Adaptation/GameAdaptation.h"
...
namespace libdash
{
    namespace framework
    {
        namespace input
        {
		    ...
		    void 			UpdateThroughput(long beginTime, long endTime, uint32_t size);
		    adaptation::ThroughputTrace*	GetCurrentThroughput();		    	
                ...
                private:
                    ...
                    bool            					isBuffering;
		    adaptation::ThroughputTrace*			currentThroughput;
		    NDNConnection   					m_ndnCon;
            };
        }
    }
}
