...
#include "../libdashframework/Adaptation/RateBaseAdaptation.h"
#include "../libdashframework/Adaptation/RateBufferBaseAdaptation.h"
#include "../libdashframework/Adaptation/ManualAdaptation.h"
#include "../libdashframework/Adaptation/GameAdaptation.h"
...
namespace sampleplayer
{
    namespace managers
    {
		...
		uint32_t						    videoBufferFillPercent;
		//void		UpdateRateBaseAdaptationParameter();
                void            UpdateThroughputTraceAdaptationParameter();
